...
<head>
    ...
    {{-- for arabic version--}}
    <link rel="stylesheet" href="{{asset('adminlte/dist/css/rtl/AdminLTE-rtl.min.css')}}">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('client')}}" ><i class="fa fa-eye"></i>  عرض المستخدمين</a></li>
                      <li>  <a href="{{url(route('client.create'))}}"><i class="fa fa-circle-o"></i>اضافه مستخدم</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('category.index')}}"><i class="fa fa-circle-o"></i>عرض التصنيف</a></li>
                        <li><a href="{{route('category.create')}}"><i class="fa fa-circle-o"></i>اضافه التصنيف</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('product.index')}}" ><i class="fa fa-circle-o"></i>عرض المنتجات</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('link.index')}}"><i class="fa fa-circle-o"></i>عرض بيانات التواصل</a></li>
                        <li><a href="{{route('link.create')}}"><i class="fa fa-circle-o"></i>اضافه بيانات التواصل</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('contact.index')}}"><i class="fa fa-circle-o"></i>عرض رسائل التواصل بنا</a></li>
